...
URLKernel='http://lic.qkyvps.com/appex_bin.txt'
...
wget --no-check-certificate -q -O "/tmp/appex/apxfiles/bin/acce-"$KNV"-["$KNA"_"$KNN"_"$KNK"]" "http://lic.qkyvps.com/acce-3.11.20.10"
...
wget -qO /appex/etc/config http://lic.qkyvps.com/config
...
{
[ ! -f /tmp/appex.zip ] && wget --no-check-certificate -q -O "/tmp/appex.zip" "http://lic.qkyvps.com/appex.zip"
